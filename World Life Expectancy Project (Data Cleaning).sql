...
/* List of countries missing a status [Afghanistan,Albania,Georgia,Georgia,United States of America,Vanuatu,Zambia,Zambia] */
...
;
		...
		# Asked 'Can we populate these cells using data surrounding them?'. Answer: YES! The Life Expectancy grows fairly linearly near the two empty cells.
SELECT Country,
YEAR,
`Life Expectancy`
FROM world_life_expectancy
...
;
        ...
        # Step 3: Calculate the average using each years' Life Expectancy using ROUND((prev + future)/2,1)
